                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-auto">
                            <a href="#" class="btn btn-light"><i
                                    class="material-icons icon-16pt text-muted mr-1">settings</i> Settings</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-header card-header-large bg-white d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="custom-control custom-checkbox-toggle ml-2">
                                <input checked="" aria-checked="true" type="checkbox" id="chart-switch-toggle"
                                    class="custom-control-input" role="switch" data-toggle="chart"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <div>
                                            <a href="#" class="text-15pt d-flex align-items-center"><i
                                                    class="material-icons icon-16pt mr-1">business</i>
                                                <strong>Hill Enterprises</strong></a>
                                        </div>
