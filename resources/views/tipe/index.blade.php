                        ...
                        <div>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tipe Transaksi</li>
                                </ol>
                            </nav>
                            <h3 class="m-0">Tipe Transaksi</h3>
                        </div>
                        <div class="ml-auto">
...
@section('own-script')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-12 col-md-12 mb-3">
                        <label for="validationSample03">Tipe Transaski</label>
                        <input type="text" class="form-control" id="validationSample03" placeholder="Masukkan Tipe Transaski"
                            required="">
                        <div class="invalid-feedback">Masukkan Tipe Transaski yang valid.</div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        <label for="edit_validationSample03">Tipe Transaski</label>
                        <input type="text" class="form-control" id="edit_validationSample03" placeholder="Masukkan Tipe Transaski"
                            required="">
                        <div class="invalid-feedback">Masukkan Tipe Transaski yang valid.</div>
                        <div class="valid-feedback"></div>
                    </div>
    ...
    <script>
        ...
        $("#store").on("click", function(e) {
            ...
            $.ajax({
                url: "/tipe-transaksi/store",
                type: "POST",
                data: {
                    nama: $("#validationSample03").val(),
        ...
        $(document).on("click", ".edit", function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    buttonEnabled(button);
                    if (response.status) {
                        $("#edit_validationSample03").val(response.data.name);
        ...
        $("#update").on("click", function(e) {
            ...
            $.ajax({
                url: "/tipe-transaksi/update",
                type: "POST",
                data: {
                    name: $("#edit_validationSample03").val(),
                    id: $("#id").val(),
                    _token: $('meta[name="csrf-token"]').attr('content')
                },
                success: function(response) {
