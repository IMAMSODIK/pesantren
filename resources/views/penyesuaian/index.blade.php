...
@section('own-script')
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <select class="form-control" id="kategori" required>
                            @foreach ($kategoris as $kat)
                                <option value="{{ $kat->kode }}">{{ $kat->name }}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">Masukkan Kategori yang valid.</div>
                        <div class="valid-feedback"></div>
                    </div>
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <textarea class="form-control" id="deskripsi" placeholder="Masukkan Deskripsi" required=""
                    ...
                    {{-- <div class="col-12 col-md-12 mb-3">
                        ...
                        <input type="file" class="form-control" id="bukti" placeholder="Masukkan Dokumen Pendukung"
                            required="" accept=".jpg,.jpeg,.png,.pdf">
                        <div class="invalid-feedback">Masukkan Dokumen Pendukung yang valid.</div>
                        <div class="valid-feedback"></div>
                    </div> --}}
                </div>
    ...
    <div id="modal-large-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-large-title"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-large-title">Detail</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="edit_deskripsi" placeholder="Masukkan Deskripsi" required=""
                                cols="5" rows="2"></textarea>
                            <div class="invalid-feedback">Masukkan Deskripsi yang valid.</div>
                            <div class="valid-feedback"></div>
                        </div>
                    ...
                    {{-- <div class="row">
                        <div class="col-12 col-md-12 mb-3">
                            <label for="edit_bukti">Dokumen Pendukung</label>
                            <input type="file" class="form-control" id="edit_bukti"
                                placeholder="Masukkan Bukti" required="" accept=".jpg,.jpeg,.png,.pdf">
                            <div class="invalid-feedback">Masukkan Dokumen Pendukung yang valid.</div>
                            <div class="valid-feedback"></div>
                        </div>
                    </div> --}}
